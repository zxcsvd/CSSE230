...
public class BSTTesting {
	...
	public void testToArrayList(){
		...
		temp.add(6);temp.add(8);temp.add(10);
		...
		temp.add(1);temp.add(2);temp.add(4);
		temp.add(6);temp.add(8);temp.add(10);
		assertEquals(temp, b.toArrayList());
		points += 4;
	}
	...
	public static void displayPoints(){
		System.out.printf("You earned %d/120 points on the unit tests\n", points);
		System.out.println("Other points will depend on style/javadoc");
	}
