...
public class EditTree {
	...
	public EditTree(char c) {
		// TODO Milestone 1
		this.root = new Node(c, NULL_NODE, NULL_NODE, 0, Code.SAME, NULL_NODE);
		this.rotationCount = 0;
	}
	...
	public char get(int pos) throws IndexOutOfBoundsException {
		...
		while (!current.equals(NULL_NODE)) {
			if (current.rank > pos) {
				current = current.left;
			} else if (current.rank < pos) {
	...
	public void add(char c) {
		// TODO: Milestone 1;
		if (root == NULL_NODE) {
			root = new Node(c, NULL_NODE, NULL_NODE, 0, Code.SAME, NULL_NODE);
	 ...
	 */
	public int size() {
		// TODO Milestone 1 (probably)
		return this.root.size();
	}

	public void rotate() {
		// I added this, we might not need it.
		// this.rotationCount+1 for single rotation
		// this.rotationCount+2 for double rotation
		// TODO Milestone 1
	}
