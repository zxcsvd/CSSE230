...
//		content.add(this.sp, BorderLayout.CENTER);
	...
	class Panel extends JPanel {
		...
		public void paintComponent(Graphics comp) {
			...
			if (b.root != null && b.root.getElement()!=null) {
		...
		public void drawRec(Node n, RedBlackTree.BinaryNode par,
			...
			double x = n.CenterX;
			double y = n.CenterY;
			if (par.getLeftChild() != null && par.getLeftChild().getElement() != null) {
			...
			if (par.getRightChild() != null && par.getRightChild().getElement() != null) {
				Line2D l1 = new Line2D.Double(x + 12.5, y +25, x + tx+12.5, y
						+ ty);
				comp2D.draw(l1);
